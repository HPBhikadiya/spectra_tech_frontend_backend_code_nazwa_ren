    ...
    <>
      ...
      <Box component="div" className={classes.container}>
        ...
        <form style={{ display: "flex", justifyContent: "flex-start" }}>
          ...
          >
            <FormLabel component="legend" style={{ color: "blue" }}>
              Options
            </FormLabel>
            <RadioGroup
              // aria-label="gender"
        ...
        {listOnDisplay?.length > 0 &&
          listOnDisplay.map((order, index) => (
            <ListItem key={index}>
              <Card
                style={{
                  width: "60%",
              ...
              >
                ...
                <Button
                  ...
                  variant="text"
                  color="primary"
                  onClick={() => onClickViewReciept(order)}
                  style={{
                    alignSelf: "center",
    ...
    <Dialog onClose={handleClose} open={open}>
      ...
      <div style={{ width: "100%", alignSelf: "center" }}>
        ...
        >
          ...
          <Typography
            variant="body1"
            style={{ marginLeft: 30, fontSize: 16, color: "black" }}
          >
            {`$${order.total_amount}`}
          </Typography>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <Typography
                      variant="body1"
                      style={{ fontSize: 13, marginLeft: 30, color: "black" }}
                    >
